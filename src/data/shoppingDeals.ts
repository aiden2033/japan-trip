...
export const shoppingDeals: ShoppingDeal[] = [
  ...
  },
  {
    ...
    shortName: 'Косметика KATE / Heroine',
  ...
  },
  {
    id: 'skin-aqua-melano',
    category: 'beauty',
    product: 'Skin Aqua, Melano CC, Softymo',
    shortName: 'Уход Skin Aqua / Melano',
  ...
  },
  {
    ...
    shortName: 'Аптечка DHC / Salonpas',
  ...
  },
  {
    ...
    shortName: 'Одежда UNIQLO / GU / MUJI',
    image: 'photos/tokyo/ginza.jpg',
  ...
  },
  {
    ...
    shortName: 'Кроссовки ASICS / Onitsuka',
  ...
  },
  {
    ...
    shortName: 'Термокружки Zojirushi',
  ...
  },
  {
    ...
    product: 'Nintendo Switch 2 Multi-Language System',
    shortName: 'Консоль Switch 2',
    image: 'photos/osaka/den-den-town.webp',
    imageLabel: 'Den Den Town: игровые магазины и техника в Осаке',
    japanPrice: 'около ¥69,980',
    worldPrice: 'около 51,500-55,000 ₽',
    savings: '35-40%',
    savingsPercent: 40,
    reason: 'Multi-Language версия дешевле РФ-импорта, но сложнее поймать',
    tags: ['taxfree', 'language', 'warranty'],
    bestPlaces: ['Осака · Bic Camera Namba / Joshin', 'Токио · Nintendo Tokyo / Yodobashi Akiba'],
    description:
      'Сильный игровой deal, но только если это Multi-Language System. Японская розница дешевле РФ-импорта, а сама консоль остается компактной travel-покупкой.',
  ...
  {
    id: 'switch2-physical-games',
    category: 'electronics',
    product: 'Nintendo Switch 2 physical games',
    shortName: 'Игры Switch 2',
    image: 'photos/osaka/den-den-town.webp',
    imageLabel: 'Den Den Town: игровые магазины и техника в Осаке',
    japanPrice: 'около ¥7,980-9,980',
    worldPrice: 'около 6,500-8,500 ₽',
    savings: '35-50%',
    savingsPercent: 50,
    reason: 'Картриджи компактны и часто дешевле РФ-импорта',
    tags: ['compact', 'taxfree', 'gift', 'language'],
    bestPlaces: ['Осака · Joshin Super Kids Land', 'Токио · Nintendo Tokyo / Yodobashi Akiba'],
    description:
      'Физические игры проще проверить и увезти, чем крупную технику. Это хороший вариант, если консоль уже есть или сам Switch 2 не попался в наличии.',
    note: 'Перед оплатой проверь языки на коробке или странице товара. У отдельных релизов может быть японская обложка и ограничения по DLC-региону.',
    buyIn: {
      osaka: ['Joshin Super Kids Land / Den Den Town', 'Bic Camera Namba', 'Yodobashi Umeda'],
      kyoto: ['Yodobashi Kyoto', 'Bic Camera JR Kyoto', 'Nintendo Kyoto'],
      tokyo: ['Nintendo Tokyo', 'Yodobashi Akiba / Shinjuku', 'Bic Camera Yurakucho'],
    },
  },
  {
    id: 'psvr2-quest3s',
  ...
  },
  {
    ...
    shortName: 'Геймпады DualSense / Switch',
    image: 'photos/tokyo/akihabara.jpg',
  ...
  },
  {
    ...
    shortName: 'Камера Fujifilm X100VI',
    image: 'photos/tokyo/daikanyama.jpeg',
  ...
  },
  {
    ...
    shortName: 'Наушники Technics / Sony',
    image: 'photos/tokyo/shibuya_cross.jpg',
  ...
  },
  {
    ...
    shortName: 'Спорт-часы Garmin 965',
  ...
  {
    id: 'panasonic-lamdash-pro',
    category: 'electronics',
    product: 'Panasonic Lamdash PRO 6 ES-L690U',
    shortName: 'Бритва Panasonic Lamdash',
    image: 'photos/osaka/umeda_sky_building.avif',
    imageLabel: 'Umeda: крупные сети техники рядом со станцией',
    japanPrice: 'около ¥55,000',
    worldPrice: 'около 56,700 ₽',
    savings: 'около 55%',
    savingsPercent: 55,
    reason: 'Японская электробритва выгодна, если модель 100-240V',
    tags: ['taxfree', 'warranty'],
    bestPlaces: ['Осака · Yodobashi Umeda', 'Токио · Bic Camera Yurakucho'],
    description:
      'Lamdash PRO 6 - один из редких вариантов японской уходовой техники, который можно брать для РФ без тяжелого трансформатора.',
    note: 'Критично: на коробке/блоке должно быть AC100-240V. Проверь точную модель, комплект и доступность сменных сеток/ножей.',
    buyIn: {
      osaka: ['Yodobashi Umeda', 'Bic Camera Namba'],
      kyoto: ['Yodobashi Kyoto', 'Bic Camera JR Kyoto'],
      tokyo: ['Bic Camera Yurakucho', 'Yodobashi Akiba / Shinjuku'],
    },
  },
  {
    id: 'refa-smartw-dryer',
    category: 'electronics',
    product: 'ReFa BEAUTECH DRYER SMART W',
    shortName: 'Фен ReFa Smart W',
    image: 'photos/osaka/umeda_sky_building.avif',
    imageLabel: 'Umeda: крупные сети техники рядом со станцией',
    japanPrice: 'около ¥40,000',
    worldPrice: 'около 32,400 ₽',
    savings: 'около 40%',
    savingsPercent: 40,
    reason: 'Берется только версия SMART W с 100-240V',
    tags: ['taxfree', 'warranty'],
    bestPlaces: ['Осака · department stores with ReFa counters', 'Токио · ReFa counters / Bic'],
    description:
      'ReFa SMART W - компактный фен для поездки и дома, если нужна именно международная версия без 100V-ловушки.',
    note: 'Проверь маркировку AC100-240V. Dyson Japan, Nanocare domestic и другие 100V-фены для РФ лучше не брать.',
    buyIn: {
  ...
  },
  {
    ...
    shortName: 'Мерч Pokemon / Nendoroid',
    image: 'photos/tokyo/akihabara.jpg',
  ...
  },
  {
    ...
    shortName: 'Арт-наборы Copic / Holbein',
  ...
  {
    id: 'snowpeak-soto-outdoor',
    category: 'outdoor',
    product: 'Snow Peak titanium mug и SOTO WindMaster',
    shortName: 'Outdoor Snow Peak / SOTO',
    image: 'photos/tokyo/kawaguchiko.webp',
    imageLabel: 'Fuji area: outdoor-покупки особенно легко оправдать маршрутом',
    japanPrice: 'около ¥3,520-9,900',
    worldPrice: 'около 6,400-15,000 ₽',
    savings: '45-70%',
    savingsPercent: 70,
    reason: 'Кружка и горелка компактны и дешевле импорта',
    tags: ['compact', 'gift', 'taxfree'],
    bestPlaces: ['Токио · WILD-1', 'Осака · Alpen Outdoors Namba'],
    description:
      'Лучше всего работают компактные товары: титановая кружка и горелка без баллона не требуют питания и обычно дешевле импорта.',
    note: 'Газовые баллоны в самолет нельзя. Покупай только саму горелку и аксессуары без топлива.',
    buyIn: {
      osaka: ['Alpen Outdoors Namba', 'Yodobashi Umeda', 'outdoor corners around Umeda / Namba'],
  ...
  {
    id: 'shimano-daiwa-reels',
    category: 'outdoor',
    product: 'Shimano / Daiwa JDM reels',
    shortName: 'Рыбалка Shimano / Daiwa',
    image: 'photos/tokyo/kawaguchiko.webp',
    imageLabel: 'Fuji area: outdoor-покупки особенно легко оправдать маршрутом',
    japanPrice: 'около ¥20,000-51,568',
    worldPrice: 'около 25,000-43,000 ₽',
    savings: '30-55%',
    savingsPercent: 55,
    reason: 'JDM-катушки дешевле РФ-импорта, но сервис японский',
    tags: ['compact', 'taxfree'],
    bestPlaces: ['Осака · fishing shops around Umeda / Namba', 'Токио · Joshuya / Sansui'],
    description:
      'Рыболовные катушки Shimano и Daiwa выгодны, если точно знаешь модель и понимаешь японскую гарантию.',
    note: 'У дорогих JDM-катушек сервис фактически японский. Сверяй передаточное число, шпулю, руку и комплектацию.',
    buyIn: {
      osaka: ['fishing shops around Umeda / Namba', 'Yodobashi Umeda', 'Alpen Outdoors Namba'],
      kyoto: ['Yodobashi Kyoto', 'Alpen / Sports Depo'],
      tokyo: ['Joshuya Shibuya / Shinjuku area', 'Sansui', 'Yodobashi Akiba'],
    },
  },
  {
    id: 'japan-esim',
    category: 'services',
    product: 'eSIM for Japan',
    shortName: 'Связь eSIM',
    image: 'photos/tokyo/shibuya_cross.jpg',
    imageLabel: 'Shibuya: связь и багажные сервисы решают логистику',
    japanPrice: 'примерно ¥1,000-3,000',
    worldPrice: 'около 3,900 ₽+ у роуминга/посредников',
    savings: 'высокая ценность',
    savingsPercent: 0,
    reason: 'Интернет без роуминга дешевле и спокойнее в поездке',
    tags: ['compact'],
    bestPlaces: ['Онлайн · Ubigi / IIJ / Willer', 'Осака · FamilyMart / аэропорт'],
    description:
      'Это не сувенир, но часто одна из самых полезных покупок: связь без роуминга и без поиска физической SIM в первый день.',
    note: 'Нужен unlocked phone с поддержкой eSIM. Проверь срок действия пакета, лимит трафика и включение tethering.',
    buyIn: {
      osaka: ['FamilyMart / IIJ eSIM', 'Kansai Airport counters', 'Ubigi / Willer online'],
      kyoto: ['FamilyMart', 'Ubigi / Willer online'],
      tokyo: ['Ubigi / Willer online', 'Narita / Haneda airport counters'],
    },
  },
  {
    id: 'yamato-luggage-delivery',
    category: 'services',
    product: 'Yamato luggage delivery',
    shortName: 'Багаж Yamato',
    image: 'photos/tokyo/shibuya_cross.jpg',
    imageLabel: 'Shibuya: связь и багажные сервисы решают логистику',
    japanPrice: 'примерно ¥2,000-3,500',
    worldPrice: 'обычно нет прямого аналога у туриста',
    savings: 'экономия сил',
    savingsPercent: 0,
    reason: 'Доставка чемодана разгружает переезды Осака-Киото-Токио',
    tags: [],
    bestPlaces: ['Осака · Yamato через отель', 'Токио · аэропорт / Yamato counters'],
    description:
      'Yamato помогает не таскать чемодан между городами и станциями. Выгода тут не в процентах, а в более спокойных переездах.',
    note: 'Нужен запас времени, корректный адрес следующего отеля и подтверждение, что отель принимает багаж заранее.',
    buyIn: {
      osaka: ['Yamato counters or hotel front desk', 'Kansai Airport counters'],
      kyoto: ['Yamato через отель', 'Kyoto Station counters'],
      tokyo: ['Yamato / JAL ABC airports', 'hotel front desk', 'convenience store shipping counters'],
    },
  },
];
